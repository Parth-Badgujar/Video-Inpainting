...
@dataclass
class VideoSmoothingPipelineOutput(BaseOutput):
    videos: Union[torch.Tensor, np.ndarray]


class VideoSmoothingPipeline(DiffusionPipeline):
    r"""
    ...
    def __call__(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                step_dict = self.scheduler.step(noise_pred, t, latents, return_dict = False,
                                                **extra_step_kwargs)
        ...
        return VideoSmoothingPipelineOutput(videos=video)
